                ...
                <div class="panel-body panel-info bk-primary text-light" style="background-color:#E8DAEF ;border-radius:50px; ">
                  <div class="stat-panel text-center">
                    ...
                    <?php
                      ...
                      $result_feedback = mysqli_query($conn, $sql_feedback) or die("query failed.");
                      $row2 = mysqli_num_rows($result_feedback);
                    ?>

                    <div class="stat-panel-number h1 "><?php echo $row2 ?></div>
                    <div class="stat-panel-title text-uppercase"> Feedback </div>
                    <br>
                    <button class="btn btn-danger" onclick="window.location.href = 'review.php';">
                      Full Detail <i class="fa fa-arrow-right"></i>
                    </button>
                  </div>
                </div>
